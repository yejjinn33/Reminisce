...
public class Smooth_follow : MonoBehaviour
{
    ...
    public DialogueManager dialogueManager; // DialogueManager 참조 추가

    private bool hasReachedBack = false; // 후면에 도달했는지 여부
    ...
    void ShowDialogueUI()
    {
        ...
        {
            dialogueManager.StartDialogue(); // DialogueManager의 StartDialogue 함수 호출
        }
    }
}
